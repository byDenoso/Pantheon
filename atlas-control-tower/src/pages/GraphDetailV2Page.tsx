...
export default function GraphDetailV2Page(){
 ...
 const api=useMemo(()=>createApi(),[]);const focus=params.get('focus')||rootFocus;const learning=params.get('learning')==='1';const selectedId=params.get('entity');const selectedEdgeId=params.get('edge');
