...
const NAVIGATION: Array<{ area: AtlasArea; label: string }> = [
  ...
  { area: 'cockpit', label: 'COCKPIT' },
  { area: 'atividade', label: 'ATIVIDADE' }
];
