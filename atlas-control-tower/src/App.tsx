...
function headerFreshness(state: AtlasUiState) {
  ...
  return { state: freshness as 'LIVE' | 'SNAPSHOT' | 'STALE' | 'DEGRADED', source: state.health?.dataSource?.effective, sourceVersion: state.health?.sourceVersion };
}
