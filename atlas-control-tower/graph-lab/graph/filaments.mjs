...
export function filamentStyle(edge,palette){
 ...
 const weighted=edge?.weight==null||String(edge.weight).trim()===''?1:(.72+.58*weight);
 return{...base,width:base.width*weighted,opacity:(.42+.58*weight)*statusAlpha,weight,statusAlpha};
}
