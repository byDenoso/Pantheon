...
const topology={
  ...
  source:{
    ...
    tower_file_id:String(projectionManifest.tower_file_id||source.tower_file_id||''),
    tower_revision:String(projectionManifest.tower_revision||source.tower_revision||''),
