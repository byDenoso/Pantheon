...
const PATHS:Record<string,string>={
  ...
  mapa:'M8 1.5 14 5v6l-6 3.5L2 11V5zM2 5l6 3.5L14 5M8 8.5v6', sistema:'M3 3h4v4H3zM9 9h4v4H9zM7 5h2a2 2 0 0 1 2 2v2M1 11h2m10-8h2', pessoal:'M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-6 6a6 6 0 0 1 12 0',
...
export function InstrumentHeader({
  ...
  const modes:Array<[ProductMode,string]>=[['inicio','Início'],['ciencia','Ciência'],['operacao','Operação'],['prova','Prova'],['sistema','Sistema'],['mapa','Mapa'],['pessoal','Pessoal']];
