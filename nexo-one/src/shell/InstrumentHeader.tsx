...
type ProductMode='observatorio'|'cockpit'|'atlas'|'sistema';
const PATHS:Record<string,string>={
  observatorio:'M2 8a6 6 0 1 0 12 0 6 6 0 0 0-12 0M8 2v2m0 8v2m-6-6h2m8 0h2',
  cockpit:'M2 2h5v5H2zM9 2h5v5H9zM2 9h5v5H2zM9 9h5v5H9z',
  atlas:'M8 1.5 10 6l4.5 2-4.5 2-2 4.5L6 10 1.5 8 6 6z',
  sistema:'M3 3h4v4H3zM9 9h4v4H9zM7 5h2a2 2 0 0 1 2 2v2M1 11h2m10-8h2',
...
export function InstrumentHeader({
  ...
  const modes:Array<[ProductMode,string]>=[['observatorio','Observatório'],['cockpit','Cockpit'],['atlas','Atlas'],['sistema','Sistema']];
  const busy=syncStatus==='SYNCING';
  return <header className="instrument-header">
    <a href="#/cockpit/comando" className="instrument-brand" onClick={e=>{e.preventDefault();onNavigate('cockpit')}} aria-label="NEXO ONE — abrir Cockpit">
