...
test('Atlas SSOT reader uses private environment configuration and cannot inherit legacy ids',()=>{
 assert.match(adapter,/DRIVE_SSOT_SPREADSHEET_ID/);
 assert.match(adapter,/CONFIG_MISSING:DRIVE_SSOT_SPREADSHEET_ID/);
